      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          {product.price ? (
            ...
            <a
              href={`https://wa.me/254732074700?text=${waMsg}`}
              target="_blank"
          ...
          <a href={`https://wa.me/254732074700?text=${waMsg}`} target="_blank" rel="noopener noreferrer" className="text-center bg-whatsapp text-white px-3 py-2 font-bold uppercase text-xs hover:brightness-110">WhatsApp</a>
        </div>
      </div>
    </div>
  );
