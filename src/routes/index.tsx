...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Buy Kentank water tanks in Kenya. 1000L from Ksh. 6,500. 3000L, 5000L, 10000L plastic water storage tanks. Add to cart or WhatsApp +254735269879." },
      { property: "og:title", content: "Kentank Water Tanks Kenya | Best Prices" },
      { property: "og:description", content: "Kentank plastic water tanks 1000L to 24000L. Add to cart or WhatsApp +254735269879 for free countrywide delivery." },
